...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/NNWZzGFpwN)
...
```sh
npx nx serve jsx-monorepo
```

To create a production bundle:

```sh
npx nx build jsx-monorepo
```

To see all available targets to run for a project, run:

```sh
npx nx show project jsx-monorepo
```
